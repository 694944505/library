...
public class Material {    
    static CATool caTool;
    static KeyPairGenerator keyPairGen;
    static private HashProvider hasher;
    static private SecureHistoryFactory historyFactory;
    static public void buildCryptoMaterial(Environment env, ServerViewController controller) throws Exception {
        SecureRandom random = new SecureRandom();
        caTool = CAToolImpl.getCATool("CommitmentTest"+controller.getStaticConf().getProcessId(),"foo".toCharArray());
